...
{
print "<table>";
print "<td><a href=searchresults.php?genre=".$genre."&subcat=".$subcat."&other=".$other."&country=".$country."&title=".$title."&lname=".$lname."&fname=".$fname."&currpage=".$currpage."&rpp=".$rpp."&photonumber=".$photoNumber."> <button type=button><b>Back to Search Results</b></button></a></td>";
print "<td><a href=search.php> <button type=button><b>Main Search Page</b></button></a></td>";
...
//print "<td><a href=searchresults.php?genre=".$genre."&subcat=".$subcat."&other=".$other."&country=".$country."&title=".$title."&lname=".$lname."&fname=".$fname."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b>Back to Search Results</b></button></a> </td>";

?>
<td><a href="searchresults.php?genre=<?php echo urlencode($genre);?>&subcat=<?php echo urlencode($subcat);?>&other=<?php echo $other;?>&country=<?php echo $country;?>&title=<?php echo $title;?>&lname=<?php echo $lname;?>&fname=<?php echo $fname;?>&currpage=<?php echo $currpage;?>&rpp=<?php echo $rpp;?>&viewtype=<?php echo $viewtype;?>&photonumber=<?php echo $searchphotonumber;?>&inventory=<?php echo $searchinventory;?>"><button type=button><b>Back to Search Results</b></button></a> </td>
<?php
print "<td><a href=search.php> <button type=button><b>Main Search Page</b></button></a></td>";
 print "<td> <button type=button onClick=window.print()><b>Print</b></button> </td>";
 print "<td><a href=display.php?photoNumber=".$search[$nextindex]."&index=".$nextindex."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b> Next>> </b></button></a></td>";
 print" </table>";
}
...
print "<td><a href=display.php?photoNumber=".$search[$previndex]."&index=".$previndex."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b><< Prev</b></button></a></td>";
?>
<td><a href="searchresults.php?genre=<?php echo urlencode($genre);?>&subcat=<?php echo urlencode($subcat);?>&other=<?php echo $other;?>&country=<?php echo $country;?>&title=<?php echo $title;?>&lname=<?php echo $lname;?>&fname=<?php echo $fname;?>&currpage=<?php echo $currpage;?>&rpp=<?php echo $rpp;?>&viewtype=<?php echo $viewtype;?>&photonumber=<?php echo $searchphotonumber?>&inventory=<?php echo $searchinventory;?>"> <button type=button><b>Back to Search Results</b></button></a> </td>
<?php 
print "<td><a href=search.php> <button type=button><b>Main Search Page</b></button></a></td>";
...
$previndex=$index-1;
print "<td><a href=display.php?photoNumber=".$search[$previndex]."&index=".$previndex."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b><< Prev</b></button></a></td>";?>
<td><a href="searchresults.php?genre=<?php echo urlencode($genre);?>&subcat=<?php echo urlencode($subcat);?>&other=<?php echo $other;?>&country=<?php echo $country;?>&title=<?php echo $title;?>&lname=<?php echo $lname;?>&fname=<?php echo $fname;?>&currpage=<?php echo $currpage;?>&rpp=<?php echo $rpp;?>&viewtype=<?php echo $viewtype;?>&photonumber=<?php echo $searchphotonumber?>&inventory=<?php echo $searchinventory;?>"> <button type=button><b>Back to Search Results</b></button></a> </td><?php
//print "<td><a href=searchresults.php?genre=".$genre."&subcat=".$subcat."&other=".$other."&country=".$country."&title=".$title."&lname=".$lname."&fname=".$fname."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b>Back to Search Results</b></button></a> </td>";
print "<td><a href=search.php> <button type=button><b>Main Search Page</b></button></a></td>";
 print "<td> <button type=button onClick=window.print()><b>Print</b></button> </td>";
