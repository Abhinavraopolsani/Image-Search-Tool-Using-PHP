...
$_SESSION[$va]=$inf['datereceived'];
   ...
   print"<h3><a href=cust.php>Back to Search</a></h3>";
   }
...
while($info=mysqli_fetch_array($sql))
{
   ...
   Print "<tr><td><img src='".$info['image']."' width=200px height=200px></img></td><td align='center'>Title: ".$info['title'] . " <br><br>
   
	Display: ".$info['displayName'] . " <br><br>
	Category: ".$info['categoryName'] . "<br><br>
	Date Received: ".$info['datereceived'] . "<br><br>
	
	<a href=display.php?photoNumber=".$info['photoNumber']."&index=".$i."&currpage=".$currpage."&rpp=".$rpp."> <button type=button><b>View Description</b></button></a><br><br><br><br></td></tr>";
...
while($info=mysqli_fetch_array($sql))
{
   ...
   Print "<tr><td><img src='".$info['image']."' width=200px height=200px></img></td><td align='center'>Title: ".$info['title'] . " <br><br>
	Photo #: ".$info['photoNumber'] . " <br><br>
	Inventory #: ".$info['inventoryNumber'] . " <br><br>&nbsp;
	Display: ".$info['displayName'] . " <br><br>
	Category: ".$info['categoryName'] . "<br><br>
	Date Received: ".$info['datereceived'] . "<br><br>
